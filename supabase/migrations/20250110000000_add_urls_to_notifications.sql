-- Update the notify_new_content function to add URLs to notification messages
...
BEGIN
  ...
  -- Append URL to message for frontend parsing (hidden from display)
  ...
  PERFORM create_notification_for_users(
    ...
    NULL   -- created_by (auto-generated, not by admin)
  );
