-- Update the create_notification_for_users function to INCLUDE admins in all notifications
-- Previously admins were excluded unless explicitly targeted
  ...
  IF p_scheduled_at IS NULL OR p_scheduled_at <= NOW() THEN
    ...
    FOR v_user_record IN
      ...
      WHERE p.id IS NOT NULL
        ...
        -- REMOVED: The line that excluded admins
    LOOP
